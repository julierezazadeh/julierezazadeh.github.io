//SCROLL DOWN TO SEE SOME OF MY CHANGES
//COMMENTS BEGIN ON LINE 407
...
var resizePizzas = function(size) {
	...
	// This switch case changes the value for the size of the pizza above the slider
	// I've changed all querySelectors to getElementById because I came around multiple articles 
	// stating that in most cases this will allow the program to run faster
	...
	// Switch case used to iterate through pizza elements on the page and changes their widths
	// The previous for loop had repeating values that made it unnecessary to keep in a loop 
...
document.addEventListener('DOMContentLoaded', function() {
	...
	// not 100% sure about this, but it appears the highest number of pizzas in the background that can be shown at on the screen are 32, 8 across x 4 down, so I changed the for loop to only loop through the ones showing on the screen (32)
	for (var i = 0; i < 32; i++) {
